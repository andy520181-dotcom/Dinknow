...
const ActivityCard: React.FC<ActivityCardProps> = ({ activity, onJoinClick }) => {
    ...
    return (
        <div className="flex flex-col overflow-hidden rounded-[20px] bg-card-grey ios-shadow p-4 active:scale-[0.98] transition-transform duration-200">
            <div className="flex justify-between items-start mb-3">
                ...
                <span className={`text-[10px] font-black px-2 py-0.5 rounded-md shadow-sm ml-3 shrink-0 uppercase tracking-tighter ${
                    activity.levelColor === 'neon' 
